    ...
    return (
        <>
            <Center py={6}>
                {
                    isLoading ? (
                        <Card width={{ base: "100%", lg: "23%", md: "30.3333%", sm: "40%" }} mt={"20px"}>
                            <CardBody>
                        ...
                        error ? (
                            ...
                            <Box
                                ...
                                <Box h={'200px'} borderBottom={'1px'} borderColor="black">
                                    <Img
                                        src={`${import.meta.env.VITE_LOCAL_HOST}${details?.attributes.thumbnail.data.attributes.formats.thumbnail.url}`}
                                        roundedTop={'sm'}
                                        objectFit="fill"
                                        h="full"
                                        w="full"
                                ...
                                <Flex borderTop={'1px'} color="black" padding={"0"}>
                                    ...
                                    <Center>
                                        <Box px={4} borderLeft={"1px solid black"} h={"full"} lineHeight={"60px"} _hover={{ bg: "#F5F5F5" }}>
                                            <Text fontSize='xl'>
